This application based on Java programming language (13.0.1 version) and Maven (3.8.1 version). I used Javafx (13.0.2 version) to build GUI, especially external libraries, such as:
- javafx-base,
- javafx-controls,
- javafx-fxml,
- javafx-graphics.
